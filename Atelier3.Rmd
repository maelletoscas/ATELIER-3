...
Consommation chez les hommes et chez le femmes
...
viande.groupe1 <- nutriage$viande[nutriage$taille <= median(nutriage$taille)]
viande.groupe2 <- nutriage$viande[nutriage$taille > median(nutriage$taille)]
100*(table(viande.groupe1)/length(viande.groupe1))
100*(table(viande.groupe2)/length(viande.groupe2))
```
...
```{r}
summary(imc)
viande.groupe1 <- nutriage$viande[nutriage$imc < 25]
viande.groupe2 <- nutriage$viande[nutriage$imc >= 25]
100*(table(viande.groupe1)/length(viande.groupe1))
100*(table(viande.groupe2)/length(viande.groupe2))
```
